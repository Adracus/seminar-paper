...
Testing is an integral part of software development. Tests help to ensure the
software meets the requirements and identify bugs. There are several kinds of
methods used in testing. Some of them focus on the exhaustiveness of the
overall testing, others to ensure that bugs that already occured do not appear
again.
