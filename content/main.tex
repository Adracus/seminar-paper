...
It is possible to share secrets with other people, but Lastpass
...
and the ability to split a secret than Lastpass.
...
The big picture seen in \ref{fig:big_picture} has three conceptual actors:
...
\begin{enumerate}
  ...
  on any specific implementation if there only is an adapter for the ORM
  duse uses.
\end{enumerate}
